...
data <- read.table(file="pathabundance_relab_unstratified.tsv", sep="\t", header=T, row.names=1,
...
fontsize=14, filename="pathabundance_relab_unstratified.tsv.pheatmap.pdf", width=6.9,
height=5.6)
