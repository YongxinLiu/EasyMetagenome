...
data <- read.table(file="humann4/path_relab_unstratified.tsv", sep="\t", header=T, row.names=1,
...
fontsize=14, filename="humann4/path_relab_unstratified.tsv.pheatmap.pdf", width=20,
height=50)
